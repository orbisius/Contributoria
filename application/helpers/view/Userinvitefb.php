 ...
 *
 */
class Helper_View_Userinvitefb extends Zend_View_Helper_Abstract {

    public function userinvitefb($friends, $registered_users) {
        ...
        foreach ($friends[0] as $f) {
            ...
            if (!in_array($f['id'], $registered_users)) {
                $link = "<a class=\"btn fb_invite\" style=\"float:right;margin:9px 30px 0 0;\" href=\"{$this->view->url()}?post_to_wall={$f['id']}\">Invite</a>";
            }
